...
import continuousDeliveryRouter from "./continuous-delivery";
import continuousDeliveryPrepareRouter from "./continuous-delivery-prepare";
...
router.use(continuousDeliveryRouter);
router.use(continuousDeliveryPrepareRouter);
